...
Route::middleware('auth')->group(function() {
	...
	Route::any('/sample/orcamento/OrcamentoEditar/qtd/editar/{id}', 'ControllerOrcamento@QtdProduto');
	Route::any('/sample/orcamento/OrcamentoEditar/gasto/editar/{id}', 'ControllerOrcamento@GastoProduto');
	Route::any('/sample/orcamento/OrcamentoEditar/taxaEntrega/editar/{id}', 'ControllerOrcamento@TaxaEntregaProduto');
	Route::any('/sample/orcamento/OrcamentoEditar/taxaAdd/editar/{id}', 'ControllerOrcamento@TaxaAddProduto');
